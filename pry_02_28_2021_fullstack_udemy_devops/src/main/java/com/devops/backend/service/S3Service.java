...
public class S3Service {
    ...
    // Este es el nombre que se usará para almacenar la imagen tanto en local como en S3
    private static final String PROFILE_PICTURE_FILE_NAME = "profilePicture";

    // 3 propiedades desde application-common.properties
    ...
    // Será invocado desde SignupController
    // Se usará el username para nombrar la carpeta dentro del Amazon S3 bucket
    /**
	...
	// Verifica que el bucket exista, si no existe lo crea. Devuelve la URL del bucket    	
    /**
